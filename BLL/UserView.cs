...
namespace lgk.BLL
{
    public class UserView
    {
        ...
        private int _c;
        private int _isht;
        private int _x;//0是后台，1是前台；

        private string cnen = "zh-cn";//默认语言版本中文

        public UserView(long ViewID, int a, int b, int c, int isht,string lang,int x)
        {
            this._ViewID = ViewID;
            this._a = a;
            this._b = b;
            ...
            if (sd.UserCode == "[注册]")
            {
                ...
                sbContent.Append("<td width=\"102\" height=\"26\"   colspan=\"2\"  class=\"cBlack\">");
                    ...
                    if (cnen == "zh-cn")
                    {
                        ...
                        {
                            sbContent.Append("<a href=\"../../Register.aspx?state=" + sd.ParentID + "," + sd.Location + "," + this._isht + "," + this._ViewID + "\">注册</a>");
                        }
                    ...
                    else
                    {
                        ...
                        {
                            sbContent.Append("<a href=\"../../Register.aspx?state=" + sd.ParentID + "," + sd.Location + "," + this._isht + "," + this._ViewID + "\">regist</a>");
                        }
            ...
            else
            {
                ...
                if (cnen == "zh-cn")
                {
                    sbContent.Append(" <table height=\"100px\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\"  class=\"" + map + "\">" +
                        "<tr height=\"5px\"><td align=\"center\"  colspan=\"3\" class=\"th\"><b><a style=\" color:Black;\" href=\"MemberTree.aspx?tt=" + sd.UserID + "\">" + sd.UserCode + "</a></b></td></tr>" +
