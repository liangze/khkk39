...
namespace Web.user
{
    public partial class savamoney : PageCore
    {
        ...
        //        dropCurrency.Items.Add(new ListItem("存币", "1"));
        ...
        {
            string strWhere = string.Format("u.UserID=" + getLoginID() + " AND (JournalType=10)");
        ...
        {
            Response.Redirect("savamoney.aspx");
        }
    }
}