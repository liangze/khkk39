    ...
    <form id="form1" runat="server">
        ...
        <div class="right_content">
            ...
            <div class="filter">
                <div class="row-fluid">
                    <div class="span4">
                        <label><%=GetLanguage("CommissionPoints")%><%--佣金点数--%>：</label>
                        <span class="field">
                            <%=LoginUser.AllBonusAccount%>
                        </span>
                    </div>
                    <!--end of span4-->
                    <div class="span4">
                        <label><%=GetLanguage("Registeredcurrency")%><%--注册点数--%>：</label>
                        <span class="field">
                 ...
                 <%--   佣金点数   AllBonusAccount
                  ...
                  持币       User012
                    ...
                    <!--end of span4-->
                    <div class="span4">
                        <label><%=GetLanguage("TradingPoints")%><%--交易点数--%>：</label>
                        <span class="field">
                            <%=LoginUser.Emoney%>
                        </span>
                    </div>
                    <!--end of span4-->
                    <div class="span4">
                        <label><%=GetLanguage("xianjin")%><%--现金币--%>：</label>
                        <span class="field">
                    ...
                    <!--end of span4-->
                    <div class="span4">
                        <label><%=GetLanguage("ActivationPoints")%><%--激活点数--%>：</label>
                        <span class="field">
                            <%=LoginUser.GLmoney%>
                        </span>
                    </div>
                    <!--end of span4-->
                    <div class="span4">
                        <label><%=GetLanguage("MallPoints")%><%--商城点数--%>：</label>
                        <span class="field">
