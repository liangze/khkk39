            ...
            if (e.CommandName.Equals("cancel")) //删除订单
            {
                ...
                try
                {
                   ...
                   // add_journal(orderInfo.UserID, orderInfo.PVTotal,0, user.ShopAccount, 7,  "删除订单", "Delete orders", orderInfo.UserID);
                    ...
                    model.UserID = orderInfo.UserID;
                    model.Remark = "删除订单";
                    model.RemarkEn = "Delete orders";
                    model.InAmount = orderInfo.PVTotal;
                    model.OutAmount = 0;
                    model.BalanceAmount = user.ShopAccount;
                    model.JournalDate = DateTime.Now;
                    model.JournalType = 7;
                    model.Journal01 = orderInfo.UserID;
                ...
                {
                    MessageBox.ShowAndRedirect(this,exc.ToString(), "order.aspx");//我的捕获异常方法
