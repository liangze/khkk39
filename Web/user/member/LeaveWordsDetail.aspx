...
<body>
    <form id="form1" runat="server">
        <div class="right_content">
            ...
            <div class="box">
                <%--<div class="capositon">
                    当前位置：信息中心>><a href="javascript:void(0)">回复信息</a>
                </div>--%>

                <div class="mailTop">
                    <div class="sendMen">
                        <span class=" ico_mail"></span>【<asp:Label ID="lblSendMember" runat="server" Text=""></asp:Label>】发件
                    </div>
                ...
                <div class="mailTop">
                    <div class="sendMen">
                        <span class=" ico_mail">主题：</span><asp:Label ID="lblSendTitle" runat="server" Text=""></asp:Label>
                    </div>
                </div>
                <!--end mailTop-->
                <div class="clear">
                        ...
                        <ItemTemplate>
                            <div class="managerReply">
                                <h2 class="cGold ico_admin">
                                    <%#Eval("UserType").ToString() == "1" ? GetUserCode(Eval("UserID").ToString(), 1) : GetUserCode(Eval("UserID").ToString(), 2)%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%#Eval("ReTime")%></h2>
                                <p>
                                </p>
                                <p class="cRed">
                                    回复：  &nbsp;&nbsp;&nbsp;  <%#Eval("ReContent")%>
