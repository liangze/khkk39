        ...
        <div class="right_content">
            ...
            <div class="filter">
                ...
                <fieldset class="legend">
                        <div class="row-fluid">
                            <div class="span4"><b><%=GetLanguage("delegType")%><%--类型--%>:</b> <%=GetLanguage("Registeredcurrency")%><%--注册点数--%></div>
                            <!--end of span4-->
                            <div class="span4"><b><%=GetLanguage("Balance")%><%--结余--%>:</b> <%=LoginUser.BonusAccount%></div>
                            <!--end of span4-->
                        </div>
                        <!--end of row fluid-->
                    </fieldset>
