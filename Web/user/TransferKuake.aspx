<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferKuake.aspx.cs" Inherits="Web.user.TransferKuake" %>
        ...
        <div class="right_content">
            ...
            <div class="filter">
                <div class="row-fluid">
                    ...
                    <p class="span3">
                        <label><%=GetLanguage("SaveTtime")%><%--存币时间--%>：</label>
                        <span class="field">
            ...
            <div class="filter">
                <div class="row-fluid">
                    ...
                    <p class="span3">
                        <asp:Button ID="btnSearch" runat="server" class="btn" OnClick="btnSearch_Click" Text="查询" />
                    </p>
                </div>
            </div>
            <table class="styled">
                <thead>
                    <tr>
                        <th> <%=GetLanguage("SaveTtime")%><%--存币时间--%>
                        </th>
                        <th>
                            <%=GetLanguage("TheTransferAmount")%>
                            <!--转账金额-->
                        </th>
                        <th style="display:none">每天收益
                        </th>
                        <th>
            ...
            <div class="pager">
                <webdiyer:AspNetPager ID="AspNetPager1" runat="server" SkinID="AspNetPagerSkin" FirstPageText="首页" OnPageChanged="AspNetPager1_PageChanged"
                    ...
                    NumericButtonCount="3" PageSize="2" ShowInputBox="Never" ShowNavigationToolTip="True"
