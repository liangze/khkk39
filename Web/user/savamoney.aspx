<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="savamoney.aspx.cs" Inherits="Web.user.savamoney" %>
        ...
        <div class="right_content">
            ...
            <div class="filter">
                ...
                <fieldset class="legend">
                        <div class="row-fluid">
                            <div class="span4"><b><%=GetLanguage("delegType")%><%--类型--%>:</b> <%=GetLanguage("cunbi")%><%--存币--%></div>
                            <!--end of span4-->
                            <div class="span4"><b><%=GetLanguage("Balance")%><%--结余--%>:</b> <%=LoginUser.User013%></div>
                            <!--end of span4-->
                        </div>
                        <!--end of row fluid-->
                    </fieldset>
