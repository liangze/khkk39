...
namespace Web.user
{
    public partial class goldcoin02 : PageCore//System.Web.UI.Page
    {
        ...
        //        dropCurrency.Items.Add(new ListItem("注册点数", "1"));
        ...
        {
            string strWhere = string.Format("u.UserID=" + getLoginID() + " AND (JournalType=1)");//journalType : 1、注册点数，2、交易点数，3、佣金点数，4、现金币，5、激活点数，6、股权，7、商城点数，8、夸克币，9、持币，10、存币
        ...
        {
            Response.Redirect("goldcoin02.aspx");
        }
    }
}