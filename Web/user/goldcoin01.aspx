            ...
            <div class="filter">
                <div class="row-fluid">
                   <%-- <p class="span3" >
                        ...
                        <span class="field" >
                            <asp:DropDownList ID="dropCurrency" runat="server" Enabled="False"></asp:DropDownList>
                        </span>
                    </p>--%>
                    <p class="span3">
                ...
                <fieldset class="legend">
                        <div class="row-fluid">
                            <div class="span4"><b><%=GetLanguage("delegType")%><%--类型--%>:</b> <%=GetLanguage("CommissionPoints")%><%--佣金点数--%></div>
                            <!--end of span4-->
                            <div class="span4"><b><%=GetLanguage("Balance")%><%--结余--%>:</b> <%=LoginUser.AllBonusAccount%></div>
                            <!--end of span4-->
                        </div>
                        <!--end of row fluid-->
                    </fieldset>
