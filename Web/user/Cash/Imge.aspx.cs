...
{
    public partial class Imge : PageCore// System.Web.UI.Page
    {
        ...
        {
            lgk.Model.Cashbuy newInfo = cashbuyBLL.GetModel(Convert.ToInt64(id));// newsBLL.GetModel(Convert.ToInt64(id));
            if (newInfo != null)
            {
