            ...
            <form id="form2" runat="server">
                <div class="announce">          
                    <marquee loop="true" scrolldelay="150" direction="left" behavior="scroll" >
                        ...
                        <ItemTemplate>                                                          
                                    <a class="fancybox fancybox.iframe"  href="member/NoticeDetail2.aspx?ID=<%#Eval("ID") %>" style="color: Red;">» <%# getstring(Language,Eval("NewsTitle").ToString(),18)%>  <%#Convert.ToDateTime(Eval("PublishTime")).ToString("")%>   </a>                                                                                          
                        </ItemTemplate>
                    </asp:Repeater>
                                ...
                                <div class="ico_body row-fluid collapse">
                                    ...
                                    <div class="span10 collapse_body">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span4">
                                                <%=GetLanguage("CurrenBalance")%><%--商城点数--%>
