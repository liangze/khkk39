<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CashBuyList.aspx.cs" Inherits="Web.admin.finance.CashBuyList" %>
    ...
    <form id="form1" runat="server">
        <div class="operation">
            <fieldset class="fieldset">
                ...
                &nbsp;&nbsp;
                求购日期：<asp:TextBox ID="txtStart" tip="输入求购日期" runat="server" onfocus="WdatePicker()" class="input_select"></asp:TextBox>
