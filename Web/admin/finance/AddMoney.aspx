            ...
            <div class="operation">
                <fieldset class="fieldset">
                    ...
                    &nbsp;&nbsp;金币类型：<asp:DropDownList ID="dropMoneyType" runat="server">
                        ...
                        <asp:ListItem Value="3" Text="佣金点数"></asp:ListItem>
                       <%-- 1、注册点数，2、交易点数，3、佣金点数，4、现金币，5、激活点数，6、股权，7、商城点数，8、夸克币，9、持币，10、存币--%>
                        <asp:ListItem Value="1" Text="注册点数"></asp:ListItem>
                        <asp:ListItem Value="8" Text="夸克币"></asp:ListItem>
                        <asp:ListItem Value="5" Text="激活点数"></asp:ListItem>
                        <asp:ListItem Value="2" Text="交易点数"></asp:ListItem>
