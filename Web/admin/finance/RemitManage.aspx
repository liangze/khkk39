                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:LinkButton ID="lbtnDetail" runat="server" CommandArgument='<%# Eval("ID") %>'
                                        CommandName="Detail" Visible='<%#Convert.ToInt32(Eval("State"))==0?true:false%>'><a class="fancybox fancybox.iframe"href="AccountRecharImg.aspx?ID=<%#Eval("ID") %>" style="color: Red;">查看凭证</a> </asp:LinkButton>&nbsp&nbsp&nbsp;
