<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationSell.aspx.cs" Inherits="Web.admin.finance.RegistrationSell" %>
    ...
    <form id="form1" runat="server">
        <div class="operation">
            <fieldset class="fieldset">
                ...
                日期：<asp:TextBox ID="txtStart" tip="输入日期" runat="server" onfocus="WdatePicker()"
                    class="input_select"></asp:TextBox>
                至<asp:TextBox ID="txtEnd" tip="输入日期" runat="server" onfocus="WdatePicker()" class="input_select"></asp:TextBox>
                ...
                <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                    <ItemTemplate>
                        <tr>                          
                            ...
                            <td align="center">
                                <%# Convert.ToInt32(Eval("IsSell")) == 1 ? "已完成" : "挂售中"%>
                            </td>                          
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
