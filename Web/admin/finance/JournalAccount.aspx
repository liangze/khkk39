        ...
        <div class="dataTable">
            <table width="99%" border="0" cellspacing="0" cellpadding="0" class="t1">
                <tr>
                    ...
                    <th align="center">佣金点数
                    </th>
                    <th align="center">注册点数
                    </th>
                    <th align="center">交易点数
                    </th>
                    <th align="center">现金币
                    </th>
                    <th align="center">激活点数
                    </th>
                    <th align="center">股权
                    </th>
                    <th align="center">商城点数
                    </th>
                    <th align="center">夸克币
                    </th>
                    <th align="center">持币
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <asp:LinkButton ID="LinkButton6" runat="server" CommandArgument='<%# Eval("UserID") %>'
                                    CommandName="ab_detail"><%#Eval("AllBonusAccount")%></asp:LinkButton>
                            </td>
                            <td align="center">
                            ...
                            <td align="center">
                                <asp:LinkButton ID="LinkButton10" runat="server" CommandArgument='<%# Eval("UserID") %>'
                                    CommandName="sh_detail"><%#Eval("ShopAccount")%></asp:LinkButton>
                            </td>
                            <td align="center">
                                <asp:LinkButton ID="LinkButton7" runat="server" CommandArgument='<%# Eval("UserID") %>'
                                    CommandName="u11_detail"><%#Eval("User011")%></asp:LinkButton>
                            </td>
                            <td align="center">
                                <asp:LinkButton ID="LinkButton8" runat="server" CommandArgument='<%# Eval("UserID") %>'
                                    CommandName="u12_detail"><%#Eval("User012")%></asp:LinkButton>
                            </td>
                            <td align="center">
                                <asp:LinkButton ID="LinkButton9" runat="server" CommandArgument='<%# Eval("UserID") %>'
                                    CommandName="u13_detail"><%#Eval("User013")%></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
