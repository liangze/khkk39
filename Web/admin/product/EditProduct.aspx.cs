    ...
    public partial class EditProduct : AdminPageBase//System.Web.UI.Page//AdminPageBase
    {
        ...
        protected void ShowInfo()
        {
           ...
           // txtShopPrice.Text = model.ShopPrice.ToString();
            txtNum.Text = model.Pic5.ToString();//库存
        ...
        protected void lbtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (GetPID() == 0)
            {
               ...
               // model.City = txtCity.Text.Trim();
                ...
                model.Price = Convert.ToDecimal(txtPrice.Text.Trim());//正常出售价
               // model.ShopPrice = Convert.ToDecimal(txtShopPrice.Text.Trim());//本站价
                model.Pic5 = txtNum.Text.Trim();//库存
