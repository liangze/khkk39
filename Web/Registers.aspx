...
<body>
    <form id="Form1" runat="server" class="stdform">
        ...
        <div class="right_content">
             <h2>
               <%=GetLanguage("Register")%> <%--会员注册--%>
             </h2>
             
             <p><font color=red>*<%=GetLanguage("Asrequired")%><%--为必填项--%></font></p>
            <h6><%=GetLanguage("LoginInformation")%>：</h6>
            <div class="row-fluid">
                <div class="span6">
                    <div class="control-group">
                        <label for="memid">
                            <span style="color: #f00;">*</span><%=GetLanguage("UserName")%><!--会员编号-->：
                        </label>
                        <div class="field">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:Button ID="btnValidate" runat="server" OnClick="btnValidate_Click" class="btn" Width="100px" />
                                </ContentTemplate>
                                <Triggers>
            ...
            <h6><%=GetLanguage("NetworkInformation")%>：</h6><!--会员资料-->
            <div class="row-fluid">
                <div class="span6">
                    <div class="control-group">
                        <label for="memid">
                   ...
                   <%-- <div class="control-group" style="display: none;">
                    ...
                    <div class="control-group">
        	<label for="memid">
        		<span style="color: #f00;">*</span><%=GetLanguage("ContactPerson")%><%--接点人--%><font color=red></font> :
        	</label>
         	<div class="field">
       ...
       <div class="control-group">
        	<label for="memid">
        		<span style="color: #f00;">*</span><%=GetLanguage("Resettlementarea")%><%--安置区域--%> <font color="red"></font> :
        	</label>
         	<div class="field">

       			<input id="radMarketOne" type="radio" name="qy" value=""  runat="server"/><%=GetLanguage("Theleftarea")%><%--左区--%> 		
       			<input id="radMarketTwo" type="radio" name="qy" value="" runat="server"/><%=GetLanguage("Therightarea")%><%--右区--%>		
         	</div>
       </div>
                </div>
            </div>
