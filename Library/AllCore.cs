...
namespace Library
{
    public class AllCore : System.Web.UI.Page
    {
        ...
        public lgk.BLL.StockSell stocksellBLL = new lgk.BLL.StockSell();

        public lgk.BLL.tb_cunbi cunbiBLL = new lgk.BLL.tb_cunbi();
        public lgk.BLL.tb_vk vkBLL = new lgk.BLL.tb_vk();
        ...
        protected override void InitializeCulture()
        {
            ...
            if (Request.Cookies["Culture"] == null)
            {
                ...
                cookie.Value = "en-us";// "zh-cn";
                cookie.Expires = DateTime.MaxValue;
                Response.Cookies.Add(cookie);
                currentCulture = "en-us";//"zh-cn";
            }
            else
            {
        ...
        public string GetLanguage(string key)
        {
            ...
            string strcukl = HttpContext.Current.Request.Cookies["Culture"].Value.ToString();
            if (strcukl == "en-us")// (Request.Cookies["Culture"].Value == "en-us")
            {
                lang = "en-us";//英语
            }
            else
        ...
        /// <returns></returns>
        public int flag_open(long iUserID, int iIsOpend ,int iMyself, int iIsAdmin)
        {
            return dal.flag_open(iUserID, iIsOpend, iMyself, iIsAdmin);
        }
        /// <summary>
        /// 开通代理商
        /// </summary>
        ...
        public string GoldType(string type)
        {
            ...
            if (currentCulture == "zh-cn")
            {
                if (d == 1)
                {
                    bi = "注册点数";//1、注册点数，2、交易点数，3、佣金点数，4、现金币，5、激活点数，6、股权，7、商城点数，8、夸克币，9、持币，10、存币
                }
                else if (d == 2)
                {
                    bi = "交易点数";
        ...
        /// <param name="type">币种</param>
        /// <returns></returns>
        public string GoldTypeZhcn(string type)
        {
            decimal d = 0;
            decimal.TryParse(type, out d);
            string bi = "";
