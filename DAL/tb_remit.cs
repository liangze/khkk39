...
namespace lgk.DAL
{
	...
	public partial class tb_remit
	{
		...
		public long Add(lgk.Model.tb_remit model)
		{
            ...
            strSql.Append("BankName,BankAccount,BankAccountUser,RechargeableDate,AddDate,State,RemitMoney,YuAmount,Remark,UserID,PassDate,Remit001,Remit002,Remit003,Remit004,Remit005,Remit006,Image");
            ...
            parameters[17].Value = model.Image;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,BankName,BankAccount,BankAccountUser,RechargeableDate,AddDate,State,RemitMoney,YuAmount,Remark,UserID,PassDate,Remit001,Remit002,Remit003,Remit004,Remit005,Remit006,Image from tb_remit ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.BigInt)};
			parameters[0].Value = ID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,BankName,BankAccount,BankAccountUser,RechargeableDate,AddDate,State,RemitMoney,YuAmount,Remark,UserID,PassDate,Remit001,Remit002,Remit003,Remit004,Remit005,Remit006 ,Image");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,BankName,BankAccount,BankAccountUser,RechargeableDate,AddDate,State,RemitMoney,YuAmount,Remark,UserID,PassDate,Remit001,Remit002,Remit003,Remit004,Remit005,Remit006,Image ");
			strSql.Append(" FROM tb_remit ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
