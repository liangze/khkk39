...
namespace lgk.DAL
{
    ...
    public partial class tb_journal
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT ID,j.UserID,u.UserCode,Remark,Remarken,InAmount,OutAmount,BalanceAmount,JournalDate,JournalType,Journal01,Journal02,Journal03,Journal04,Journal05,Journal06,Journal07");
